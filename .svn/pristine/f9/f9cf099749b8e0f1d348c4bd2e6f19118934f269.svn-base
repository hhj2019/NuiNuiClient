...
public class Main extends Application {
	...
	// File file3 = new
	// File("D:\\A_TeachingMaterial\\MiddleProject\\MusicLibrary\\007. 장범준 -
	// 노래방에서.mp3");
	public static String music_file_temp = "D:\\A_TeachingMaterial\\MiddleProject\\MusicLibrary\\FANCY.mp3";
	File file3;
	 ...
	 * 파일찾기 버튼
	 */
	public void setButtonAction() { // 2. setButtonAction 메서드 호출
		...
		// }
		// });
		file3 = new File(music_file_temp);
		Platform.runLater(() -> openFile(file3));
