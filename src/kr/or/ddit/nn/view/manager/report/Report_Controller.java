...
public class Report_Controller implements Initializable {
	...
	@FXML 
	TableColumn<ReportVO, String> report_memid;
	@FXML 
	TableColumn<ReportVO, String> report_ing;
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		report_memid.setStyle("-fx-alignment: CENTER;");
		...
		try {
			reportData.setAll(report.selectAllReport());
		...
		report_memid.setCellValueFactory(new PropertyValueFactory<>("mem_id"));
